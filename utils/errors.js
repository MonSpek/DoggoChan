...
module.exports.botNotInVC = (message) => {
    let embed = new Discord.RichEmbed()
        .setTitle("Error")
        .setDescription("I am not connected to a VC.")
        .setColor(config.red)

    message.channel.send(embed).then(m => m.delete(5000));
}

module.exports.diffVC = (message) => {
    let embed = new Discord.RichEmbed()
        .setTitle("Error")
        .setDescription("Sorry, you are not in the same VC as me")
        .setColor(config.red)
